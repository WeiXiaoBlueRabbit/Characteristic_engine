...
enum poke_abilities
{
		...
		ABILITY_GORILLA_TACTICS, //0x100
        ABILITY_NEUTRALIZING_GAS,  // 0x101
		ABILITY_PASTEL_VEIL,  // 0x102
		ABILITY_HUNGER_SWITCH,  // 0x103
		ABILITY_QUICK_DRAW,  // 0x104	
		ABILITY_UNSEEN_FIST // 0x105
